<template>
  <div class="stats-bar">
    ...
    <div class="stats-bar__static">
      <div v-for="(stat, idx) in stats" :key="stat.label" class="stats-bar__item">
        <div class="stats-bar__number">
          <EditableText tag="span" class="stats-bar__value" :content-key="`home.stats.${idx}.value`" page="home" :default="stat.value" /><EditableText tag="span" class="stats-bar__suffix" :content-key="`home.stats.${idx}.suffix`" page="home" :default="stat.suffix" />
        </div>
        <EditableText tag="p" class="stats-bar__label" :content-key="`home.stats.${idx}.label`" page="home" :default="stat.label" />
      </div>
    </div>
      ...
      <div class="stat">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          <path
            ...
            stroke="#2F8F83" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <EditableText tag="div" class="span" content-key="home.stats_bar.mobile_note_1" page="home" default="24h Response Fast Staffing Coverage" />
      </div>
      <div class="stat">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M5 8L11 14" stroke="#2F8F83" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M4 14L10 8L12 5" stroke="#2F8F83" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M2 5H14" stroke="#2F8F83" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M7 2H8" stroke="#2F8F83" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M22 22L17 12L12 22" stroke="#2F8F83" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M14 18H20" stroke="#2F8F83" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
        <EditableText tag="div" class="span" content-key="home.stats_bar.mobile_note_2" page="home" default="Multilingual Diverse Professionals" />
      </div>
    </div>
  </div>
</template>
...
@keyframes stats-scroll {
  ...
  // -50% scrolls exactly one copy (half the duplicated track)
}
</style>
