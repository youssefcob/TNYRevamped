...
import SolutionSpotlightSection from '@/Components/Solutions/detail/SolutionSpotlightSection.vue';
...
<template>
  ...
  <LayoutV2>
    ...
    <SolutionSpotlightSection :solution="props.solution" :page-key="props.pageKey" />
