...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const submit = async () => {
      ...
      router.post(`/vacancy/edit/${props.vacancy.id}`, form, {
        // headers: {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(MainOverLay, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container" data-v-fc8fb91d${_scopeId}><div class="box-wrapper-border" data-v-fc8fb91d${_scopeId}><h2 class="title" data-v-fc8fb91d${_scopeId}>Welcome</h2><form method="POST" data-v-fc8fb91d${_scopeId}><input type="hidden" name="_token"${ssrRenderAttr("value", csrfToken.value)} data-v-fc8fb91d${_scopeId}>`);
            _push2(ssrRenderComponent(InputField, {
              ...
              value: __props.vacancy.address
            }, null, _parent2, _scopeId));
            _push2(`<div class="split" data-v-fc8fb91d${_scopeId}>`);
            _push2(ssrRenderComponent(DropDownInputField, {
              ...
              value: __props.vacancy.facility_type
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(DropDownInputField, {
              label: "Role",
              ...
              value: __props.vacancy.position.title
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="split" data-v-fc8fb91d${_scopeId}>`);
            _push2(ssrRenderComponent(InputField, {
              ...
              value: __props.vacancy.availability_to_start
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(DropDownInputField, {
              label: "Gender",
              ...
              value: __props.vacancy.gender_pref
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="split" data-v-fc8fb91d${_scopeId}>`);
            _push2(ssrRenderComponent(DropDownInputField, {
              label: "Shift Type",
              ...
              value: __props.vacancy.shift_details
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(InputField, {
              ...
              value: __props.vacancy.experience.toString()
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="split" data-v-fc8fb91d${_scopeId}>`);
            _push2(ssrRenderComponent(DropDownInputField, {
              label: "Borough",
            ...
            _push2(ssrRenderComponent(DropDownInputField, {
              ...
              value: __props.vacancy.language_pref
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="split" data-v-fc8fb91d${_scopeId}>`);
            _push2(ssrRenderComponent(DropDownInputField, {
              label: "Payment Type",
              ...
              value: __props.vacancy.payment_type
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(DropDownInputField, {
              label: "Legal Status",
              ...
              value: __props.vacancy.legal_status
            }, null, _parent2, _scopeId));
            _push2(`</div>`);
            _push2(ssrRenderComponent(WorkDays, {
              modelValue: form.work_days,
              "onUpdate:modelValue": ($event) => form.work_days = $event,
              value: __props.vacancy.work_days
            }, null, _parent2, _scopeId));
            _push2(`<div class="btn-container" data-v-fc8fb91d${_scopeId}><button type="submit" class="btn"${ssrIncludeBooleanAttr(loading.value) ? " disabled" : ""} data-v-fc8fb91d${_scopeId}>${ssrInterpolate(loading.value ? "Loading..." : "Save")}</button></div></form></div></div>`);
          } else {
            return [
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "split" }, [
                      ...
                      createVNode(DropDownInputField, {
                        ...
                        "onUpdate:modelValue": ($event) => form.position = $event,
                        value: __props.vacancy.position.title
                      }, null, 8, ["list", "modelValue", "onUpdate:modelValue", "value"])
                    ]),
                    createVNode("div", { class: "split" }, [
                      createVNode(InputField, {
                        label: "Availability to start",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Employers/EditVacancy.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const EditVacancy = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fc8fb91d"]]);
export {
  EditVacancy as default
};
