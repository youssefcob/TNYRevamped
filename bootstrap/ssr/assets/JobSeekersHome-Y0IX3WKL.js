import { defineComponent, unref, mergeProps, useSSRContext, onMounted, withCtx, createVNode } from "vue";
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent } from "vue/server-renderer";
import { _ as _sfc_main$2, A as AboutUs, N as Numbers, W as WhatSetsUs, S as Services, a as NewsAndEvents, C as Clients, T as Testimonials, b as Team, c as ContactUs, M as Map } from "./Services-D9r0IgR9.js";
import { J as Jobs } from "./Jobs-XKyZ9k8Y.js";
import { u as user, M as MainOverLay } from "./MainOverLay-f11KXQRE.js";
import { v as vacanciesState, b as assignHero, c as assignService, e as assignJob, f as assignNews, g as assignClient, h as assignTestimonial, i as assignTeam, l as assignVacancies, m as assignJobSeekerProfile, s as snack } from "./NavBarV2-BlC3_Oet.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(vacanciesState).length > 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))} data-v-ed91fe2f><h2 class="title" data-v-ed91fe2f>Vacancies</h2><br data-v-ed91fe2f><h2 class="subtitle" data-v-ed91fe2f>TNY Staffing Corporation </h2><h3 data-v-ed91fe2f>Your Gateway to Top-tier Talent and Seamless Integration</h3><br data-v-ed91fe2f><br data-v-ed91fe2f><br data-v-ed91fe2f><div class="job-seeker-wrapper" data-v-ed91fe2f><!--[-->`);
        ssrRenderList(unref(vacanciesState), (vacancy) => {
          _push(ssrRenderComponent(VacancyCard, {
            key: vacancy.id,
            vacancy
          }, null, _parent));
        });
        _push(`<!--]--></div><a href="vacancies" class="more" data-v-ed91fe2f>Show More Vacancies</a></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/JobSeeker/Home/Vacancies/Vacancies.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const Vacancies = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ed91fe2f"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "JobSeekersHome",
  __ssrInlineRender: true,
  props: {
    user: {
      type: Object
      ...
      _push(ssrRenderComponent(MainOverLay, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</section><section${_scopeId}>`);
            _push2(ssrRenderComponent(Vacancies, null, null, _parent2, _scopeId));
            _push2(`</section><section${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/JobSeekers/JobSeekersHome.vue");
